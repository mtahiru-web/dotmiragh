        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <article className="rounded-2xl overflow-hidden border border-border bg-card group">
            ...
            <div className="p-6">
              ...
              <a href="https://produselldistribution.com" target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-primary hover:underline">
